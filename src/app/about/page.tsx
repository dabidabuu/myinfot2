       ...
       <main className="max-w-6xl mx-auto px-4 py-12 ">
                      <section className="flex flex-col-reverse sm:flex-row items-center">
                          <div className="sm:w-1/2 text-center sm:text-left">
                              ...
                              <p className="text-lg text-gray-200 mb-6">Welcome to our corner of the web! we're a passionate programmer with a love for coding, problem-solving, and creating innovative solutions. With a deep interest in both front-end and back-end technologies, we enjoy building seamless, user-friendly experiences and scalable, efficient systems.Over the years, we’ve honed my skills in a variety of programming languages, frameworks, and tools, including but not limited to JavaScript, Python, Java, React, Node.js, and SQL. Our focus is on writing clean, maintainable code that not only works but works well, ensuring optimal performance and long-term sustainability.Beyond coding, we thrive on collaboration and learning from others. Whether it’s working with teams or contributing to open-source projects, We believe that great software is the result of diverse ideas and teamwork.On this page, you’ll find examples of our work, insights into our programming journey, and thoughts on the ever-evolving world of technology. Feel free to browse, connect, and reach out if you want to collaborate or chat about programming!Let’s build something amazing together!</p>
                          </div>
